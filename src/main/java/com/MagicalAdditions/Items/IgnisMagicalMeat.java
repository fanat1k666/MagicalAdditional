...
public class IgnisMagicalMeat extends ItemFood {

    public static void mainRegistry() {
        initializeItem();
    }

    public static Item IgnisMagicalMeat;
    ...
    public IgnisMagicalMeat (int Efficiency, int lvl ,boolean c, String texture, String name, int maxStackSize) {
        super(Efficiency,c);
    ...
    public static void initializeItem() {
        IgnisMagicalMeat = new IgnisMagicalMeat(6, 16, false, "ignismeat", "ignismeat", 64).setAlwaysEdible();
    }
