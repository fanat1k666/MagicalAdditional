...
public class PerditioMagicalMeat extends ItemFood {

    public static void mainRegistry() {
        initializeItem();
    }

    public static Item PerditioMagicalMeat;
    ...
    public PerditioMagicalMeat (int Efficiency, int lvl ,boolean c, String texture, String name, int maxStackSize) {
        super(Efficiency,c);
    ...
    public static void initializeItem() {
        PerditioMagicalMeat = new PerditioMagicalMeat(6, 16, false, "perditiomeat", "perditiomeat", 64).setAlwaysEdible();
    }
