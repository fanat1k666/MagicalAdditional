...
public class TerraMagicalMeat extends ItemFood {

    public static void mainRegistry() {
        initializeItem();
    }

    public static Item TerraMagicalMeat;
    ...
    public TerraMagicalMeat (int Efficiency, int lvl ,boolean c, String texture, String name, int maxStackSize) {
        super(Efficiency,c);
    ...
    public static void initializeItem() {
        TerraMagicalMeat = new TerraMagicalMeat(6, 16, false, "terrameat", "terrameat", 64).setAlwaysEdible();
    }
