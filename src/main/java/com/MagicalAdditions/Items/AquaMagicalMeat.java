...
public class AquaMagicalMeat extends ItemFood {

    public static void mainRegistry() {
        initializeItem();
    }

    public static Item AquaMagicalMeat;
    ...
    public AquaMagicalMeat (int Efficiency, int lvl ,boolean c, String texture, String name, int maxStackSize) {
        super(Efficiency,c);
    ...
    public static void initializeItem() {
        AquaMagicalMeat = new AquaMagicalMeat(6, 16, false, "aquameat", "aquameat", 64).setAlwaysEdible();
    }
